	...
	return (
		<div onMouseEnter={() => setActive(item)} onMouseLeave={() => setActive(null)} className="relative ">
			<motion.p
				...
				className="cursor-pointer text-black hover:opacity-[0.9] hover:scale-105 dark:text-white"
			>
				{item}
			</motion.p>
			{active !== null && (
...
export const Menu = ({
	...
	return (
		<nav
			...
			className="relative max-w-7xl mx-auto border border-transparent shadow-input flex justify-between items-center space-x-4 px-8 py-1 sm:py-2"
		>
			{children}
		</nav>
	);
