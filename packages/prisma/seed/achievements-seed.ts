...
const badges = [
    ...
    // ================================================================================
    // Tier 1
    { slug: "first-concept", name: "Curious Mind", description: "Complete your first concept", category: "CONCEPTS", rarity: "COMMON", tier: 1, icon: "💡", color: "#fbbf24", bgGradient: "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)", requirements: { type: "count", target: "concepts_completed", count: 1 }, xpReward: 50, creditsReward: 5, order: 1 },
    { slug: "concept-explorer", name: "Concept Explorer", description: "Complete 5 concepts", category: "CONCEPTS", rarity: "COMMON", tier: 1, icon: "🔍", color: "#60a5fa", bgGradient: "linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%)", requirements: { type: "count", target: "concepts_completed", count: 5 }, xpReward: 100, creditsReward: 10, order: 2 },
    // Tier 2
    { slug: "concept-learner", name: "Concept Learner", description: "Complete 20 concepts", category: "CONCEPTS", rarity: "RARE", tier: 2, icon: "📖", color: "#22d3ee", bgGradient: "linear-gradient(135deg, #22d3ee 0%, #06b6d4 100%)", requirements: { type: "count", target: "concepts_completed", count: 20 }, xpReward: 250, creditsReward: 25, order: 3 },
    { slug: "concept-quiz-pro", name: "Concept Quiz Pro", description: "Score 90%+ on 10 concept quizzes", category: "CONCEPTS", rarity: "RARE", tier: 2, icon: "📝", color: "#a78bfa", bgGradient: "linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%)", requirements: { type: "score", target: "concept_quiz_high", count: 10, minScore: 90 }, xpReward: 300, creditsReward: 30, order: 4 },
    // Tier 3
    { slug: "concept-master", name: "Concept Master", description: "Complete 50 concepts", category: "CONCEPTS", rarity: "EPIC", tier: 3, icon: "🎓", color: "#ec4899", bgGradient: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)", requirements: { type: "count", target: "concepts_completed", count: 50 }, xpReward: 600, creditsReward: 60, order: 5 },
    { slug: "multi-category", name: "Multi-Category Expert", description: "Complete concepts in 10 different categories", category: "CONCEPTS", rarity: "EPIC", tier: 3, icon: "🎯", color: "#f97316", bgGradient: "linear-gradient(135deg, #f97316 0%, #ea580c 100%)", requirements: { type: "count", target: "concept_categories_completed", count: 10 }, xpReward: 500, creditsReward: 50, order: 6 },
    // Tier 4
    { slug: "concept-legend", name: "Concept Legend", description: "Complete 100 concepts", category: "CONCEPTS", rarity: "LEGENDARY", tier: 4, icon: "👑", color: "#f59e0b", bgGradient: "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)", requirements: { type: "count", target: "concepts_completed", count: 100 }, xpReward: 1500, creditsReward: 150, order: 7 },
    // Tier 5
    { slug: "concept-deity", name: "Concept Deity", description: "Complete 200 concepts with 95%+ average quiz score", category: "CONCEPTS", rarity: "MYTHIC", tier: 5, icon: "🌟", color: "#c084fc", bgGradient: "linear-gradient(135deg, #c084fc 0%, #a855f7 100%)", requirements: { type: "combined", targets: ["concepts_completed", "concept_quiz_average"], count: 200, minScore: 95 }, xpReward: 3000, creditsReward: 300, order: 8 },
