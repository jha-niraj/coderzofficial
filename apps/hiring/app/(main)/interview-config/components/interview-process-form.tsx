...
import { Plus, Trash2, GripVertical, Mic, Clock, ChevronDown, ChevronUp, Save, Loader2 } from "lucide-react"
...
import { createInterviewProcess, InterviewRoundInput, InterviewProcessInput } from "@/actions/interview-config"
...
export function InterviewProcessForm({ onClose }: InterviewProcessFormProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const input: InterviewProcessInput = {
                ...
                rounds: rounds.map(({ isExpanded, ...round }) => round)
            }
