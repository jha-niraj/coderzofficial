        ...
        <>
            <div className={cn("p-6 flex items-center relative border-b border-neutral-200 dark:border-neutral-800", isCollapsed ? "justify-center" : "gap-3")}>
                <Link href="/home" className="flex items-center gap-3">
                    <div className="relative h-10 w-10 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-violet-600 to-indigo-600 rounded-xl">
                        <GraduationCap className="h-6 w-6 text-white" />
                    </div>
                    {
                        !isCollapsed && (
                            <div className="flex-1 text-left min-w-0 hidden lg:block">
                                <h1 className="font-bold text-neutral-900 dark:text-white truncate tracking-tight">Coder&apos;z Uni</h1>
                                <p className="text-[10px] text-violet-600 dark:text-violet-400 truncate uppercase tracking-widest font-mono">
                                    Admin Portal
                                </p>
                            </div>
                        )
            ...
            <ScrollArea className="flex-1">
                <nav className="px-3 py-4 space-y-1">
                    ...
                    {uniNavigation.secondary.map((item) => renderNavItem(item))}
                </nav>
            </ScrollArea>
