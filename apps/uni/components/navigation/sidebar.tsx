...
import {
    LogOut, ChevronLeft, ChevronRight, Menu, GraduationCap, Home, Users,
    BookOpen, Building2, BarChart3, Settings, CreditCard,
    HelpCircle, UserPlus, Briefcase, School, FolderKanban
} from "lucide-react"
import {
...
const navItems = [
    ...
    { path: "/faculty", name: "Faculty", icon: <UserPlus className="h-5 w-5" /> },
    { path: "/classes", name: "Classes", icon: <School className="h-5 w-5" /> },
    { path: "/assignments", name: "Assignments", icon: <BookOpen className="h-5 w-5" /> },
    { path: "/departments", name: "Departments", icon: <FolderKanban className="h-5 w-5" /> },
    { path: "/placements", name: "Placements", icon: <Briefcase className="h-5 w-5" /> },
    { path: "/analytics", name: "Analytics", icon: <BarChart3 className="h-5 w-5" /> },
]

const bottomNavItems = [
    { path: "/university", name: "University", icon: <Building2 className="h-5 w-5" /> },
            ...
            <div className="flex flex-col h-full">
                <div className={cn(
                    ...
                    <Link href="/home" className={cn(
                        ...
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-105">
                        ...
                        </div>
                        {
                            !isCollapsed && (
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] font-mono text-violet-600 dark:text-violet-400 uppercase tracking-widest mt-0.5">
                                        Admin Portal
                                    </span>
                                </div>
                            )
                            ...
                            <div className={cn("flex items-center", isCollapsed ? "justify-center" : "gap-3")}>
                                {
                                    session.user?.image ? (
                                        ...
                                        <div className={cn(
                                            "rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center flex-shrink-0",
