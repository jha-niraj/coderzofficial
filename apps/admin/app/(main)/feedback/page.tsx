...
export default function FeedbackPage() {
    ...
    async function handleStatusChange(feedbackId: string, newStatus: "UNDER_REVIEW" | "PLANNED" | "COMPLETED") {
        try {
    ...
    async function handleAssignReward(feedbackId: string, credits: number, xp: number) {
        try {
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <select
                                            ...
                                            className="px-3 py-1.5 text-sm rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500/20"
                                        >
                                            <option value="UNDER_REVIEW">Under Review</option>
                                            <option value="PLANNED">Planned</option>
                                            <option value="COMPLETED">Completed</option>
