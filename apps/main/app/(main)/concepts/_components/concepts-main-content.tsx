...
import { ConceptDifficulty } from "@repo/prisma/client";
...
interface ConceptsMainContentProps {
    concepts: Concept[];
...
export function ConceptsMainContent({
    concepts,
    pagination,
    userProgress,
    completedConcepts,
    ...
    const getFilterTitle = () => {
        ...
        if (currentFilter === "trending") return "Trending Concepts";
        if (currentFilter === "popular") return "Popular Concepts";
        return "All Concepts";
    };
                                                        ...
                                                        <div className="flex items-center gap-1.5">
                                                            <Avatar className="w-5 h-5">
                                                                ...
                                                                <AvatarFallback className="text-[10px]">
                                                                    {concept.creator.name?.charAt(0)}
                                                                </AvatarFallback>
                                                            </Avatar>
                                                            <span className="text-xs text-neutral-500">
                                                                {concept.creator.name}
                                                            </span>
                                                        </div>
                    ...
                    <TabsContent value="progress" className="mt-0 space-y-8">
                            ...
                            {userProgress.length === 0 ? (
                                <Card className="p-8 text-center border-dashed">
                                    ...
                                    <p className="text-neutral-500">
                                        Start learning a concept to track your progress here.
                                    </p>
                                </Card>
                            ) : (
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    {userProgress.map((progress) => (
                                        <Link key={progress.id} href={`/concepts/${progress.concept.slug}`}>
                                                ...
                                                <div className="flex items-center gap-3 mb-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-xs text-neutral-500">
                                                            {progress.concept._count?.steps || 0} steps
                                                        </p>
                                                    </div>
                                                </div>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                                ...
                                Completed
                                <Badge variant="secondary">{completedConcepts.length}</Badge>
                            </h3>
                            {completedConcepts.length === 0 ? (
                                <Card className="p-8 text-center border-dashed">
                                    <CheckCircle2 className="w-10 h-10 text-neutral-300 mx-auto mb-3" />
                                    <p className="text-neutral-500">
                                        Complete a concept to see it here.
                                    </p>
                                </Card>
                            ) : (
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    {completedConcepts.map((progress) => (
                                        <Link key={progress.id} href={`/concepts/${progress.concept.slug}`}>
