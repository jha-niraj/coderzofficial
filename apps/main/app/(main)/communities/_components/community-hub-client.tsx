...
import {
    Users, Sparkles, ChevronRight, RefreshCw, Plus, Loader2,
    CheckCircle2, Settings, TrendingUp, Eye, ChevronDown,
    MessageSquare
} from 'lucide-react'
...
import {
    useCommunityStore, type CommunityBasic
} from '@/app/store/communityStore'
                    ...
                    selectedCommunity ? (
                        ...
                        <>
                            <div className='flex flex-col gap-4'>
                                {
                                    featuredCommunities.length > 0 ? featuredCommunities.map((community) => (
                                        <CommunityCard
                                            key={community.id}
                                            community={community}
                                            isMember={joinedCommunities.has(community.id)}
                                        ...
                                        <div className="text-center py-8">
                                            <p className="text-neutral-500 dark:text-neutral-400">No featured communities found</p>
                                        </div>
                                    )
                                }
                            </div>
