...
const suggestionQuestions = [
    ...
    "How does this relate to other Learns?",
];
...
export default function AIAssistantPanel({
    ...
    const sendMessage = async (content: string) => {
        ...
        const aiMessage: Message = {
            ...
            role: "assistant",
            content: generateMockResponse(content, LearnTitle, currentStep.title),
        };
            ...
            <div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Ask anything about this Learn</p>
                    </div>
                </div>
                    ...
                    messages.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-6 max-w-[250px]">
                                Ask questions about &quot;{currentStep.title}&quot; or the entire Learn.
                            </p>
...
function generateMockResponse(question: string, LearnTitle: string, stepTitle: string): string {
...
Imagine you're building a social media app like Instagram. This Learn would be used when:
...
The key takeaway is that understanding this Learn will help you build better, more scalable applications.`;
    }
...
Pro tip: When learning this, try to implement it in a small project. That's where real learning happens!`;
    ...
    if (lowerQuestion.includes("relate") || lowerQuestion.includes("connection")) {
        return `Great question about connections! "${stepTitle}" relates to several other Learns:
...
This Learn is fundamental to understanding ${LearnTitle}. It helps you build a mental model for how things work under the hood.
