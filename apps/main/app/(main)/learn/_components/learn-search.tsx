...
export default function LearnsSearch() {
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        if (query.trim()) {
            router.push(`/Learns/browse?search=${encodeURIComponent(query.trim())}`);
        }
    };

    const handlePopularSearch = (term: string) => {
        router.push(`/Learns/browse?search=${encodeURIComponent(term)}`);
    };
                ...
                <form onSubmit={handleSearch} className="relative">
                    <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                            ...
                            <Input
                                type="text"
                                placeholder="Search Learns... (e.g., React hooks, SQL joins, System design)"
                                value={query}
