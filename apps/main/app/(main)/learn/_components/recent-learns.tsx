...
interface RecentLearnsProps {
    Learns: Learn[];
}

const difficultyColors: Record<LearnDifficulty, string> = {
...
export default function RecentLearns({ Learns }: RecentLearnsProps) {
    if (Learns.length === 0) {
        return (
            <section>
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 mt-1">
                        Fresh Learns to explore
                    </p>
                </div>
                <Link
                    href="/Learns/browse?sortBy=latest"
                                ...
                                <Card className="group h-full overflow-hidden bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-lg transition-all duration-300">
                                    <CardContent className="p-4">
                                        ...
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <Badge className={`text-xs ${difficultyColors[learn.difficulty as keyof typeof difficultyColors]}`}>
                                                {learn.difficulty}
                                            </Badge>
                                        </div>
