...
import {
    ...
    Mic, Star, Heart, TrendingUp, Users, CheckCircle2
} from "lucide-react"
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-wrap gap-2 mb-3">
                                                    {
                                                        Array.isArray(job.skillsRequired) && job.skillsRequired.slice(0, 5).map((skill, i) => (
                                                    ...
                                                    {
                                                        Array.isArray(job.skillsRequired) && job.skillsRequired.length > 5 && (
                                                            <Badge variant="secondary" className="text-xs">
