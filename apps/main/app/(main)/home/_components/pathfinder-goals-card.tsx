...
export default function PathfinderGoalsCard({ goals }: PathfinderGoalsCardProps) {
    ...
    const handlePathfinderClick = (e: React.MouseEvent) => {
        e.preventDefault()
                ...
                <CardContent className="space-y-3">
                    {activeGoals.length === 0 ? (
                        ...
                        >
                            ...
                            <Button onClick={handlePathfinderClick}>
                                Go to Pathfinder
                            </Button>
                        </motion.div>
                    ) : (
            ...
            <Dialog open={showComingSoon} onOpenChange={setShowComingSoon}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Pathfinder is under development. Stay tuned for learning paths and goals!
                        </DialogDescription>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
