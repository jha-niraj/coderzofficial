...
import {
    Globe, Github, Twitter, Eye, ThumbsUp, ThumbsDown,
    MessageSquare, Share2, Calendar, User, Tag, Zap, CheckCircle,
    ArrowUpRight, Send, Rocket
} from "lucide-react"
...
export function ProductDetail({ product }: ProductDetailProps) {
    ...
    // Parse features - features is stored as JSON directly
